...
SDL_Point Controller::lastMousePos = { Controller::mouseX, Controller::mouseY };
...
SDL_Point Controller::mouseWheelMovment;
Uint32 Controller::state = Controller::STATE_TITLE;
